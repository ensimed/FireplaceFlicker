...
{
    public class CottageSauna : MonoBehaviour
    {
        ...
        void Update()
        {
            LightObject = GameObject.Find("COTTAGE/Sauna/Stove/Flame/FireEffects/Light");
            FireplaceLight = GameObject.Find("COTTAGE/Sauna/Stove/Flame/FireEffects/Light").GetComponent<Light>();
